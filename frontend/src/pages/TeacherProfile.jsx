...
const TeacherProfile = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Only include profilePicture if it has changed and is a new base64 string
      const updateData = {
        name: formData.name,
      ...
      // Only include profilePicture if it's a new upload (data URL starts with data:image)
    ...
    <div className="teacher-profile">
      <div className="profile-container">
        <div className="profile-header">
          ...
          <p>Update your personal information and designations</p>
        </div>
        ...
        <form className="profile-form" onSubmit={handleSubmit}>
          ...
          <div className="form-section">
            ...
            <div className="form-group">
              <label htmlFor="designation">Designation / Subject</label>
              <input
                type="text"
                id="designation"
                name="designation"
                ...
                onChange={handleChange}
                placeholder="e.g., Physics Teacher, Mathematics Instructor"
              />
            </div>
